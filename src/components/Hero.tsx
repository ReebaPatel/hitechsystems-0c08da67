    ...
    <section id="home" className="relative min-h-screen flex items-center pt-16">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-primary-foreground mb-6 animate-slide-in leading-tight">
            100% Trusted<br />
          ...
          <div className="grid grid-cols-3 gap-6 max-w-2xl">
            <div className="text-center p-4 bg-primary-foreground/10 backdrop-blur-sm rounded-lg border border-primary-foreground/20 animate-scale-in">
            ...
            <div className="text-center p-4 bg-primary-foreground/10 backdrop-blur-sm rounded-lg border border-primary-foreground/20 animate-scale-in" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="text-center p-4 bg-primary-foreground/10 backdrop-blur-sm rounded-lg border border-primary-foreground/20 animate-scale-in" style={{ animationDelay: "0.2s" }}>
              <div className="text-3xl md:text-4xl font-bold text-secondary mb-1">10+</div>
